...
public class SceneHandler : MonoBehaviour
{
    ...
    public void UnloadSceneFromName(string sceneName)
    {
        ...
        {
            Debug.LogError($"[UnloadSceneFromName] La scena '{sceneName}' non � caricata.");
            return;
        }

        if (isLoading)
        {
            Debug.LogWarning("[UnloadSceneFromName] Una scena � gi� in fase di caricamento/scaricamento.");
            return;
        }
    ...
    private IEnumerator LoadSceneCoroutine(string sceneName)
    {
        ...
        if (!string.IsNullOrEmpty(currentScene))
        {
            ...
            {
                Debug.LogWarning($"[LoadSceneCoroutine] La scena '{currentScene}' non � valida o non � caricata.");
            }
        }
